...
import P8 from './ProjectComponents/PollsWebApp'
        ...
        <div className="resume-section-content">
          <h2 className="mb-5">Projects</h2>
            ...
            <div className="d-flex flex-column flex-md-row justify-content-between">
                ...
                <h3 className="mb-0"><a className="social-icon" href="https://github.com/barojin/"><i className="fab fa-github" /></a> Covid Case Tracker <span className="text-primary">[AWS(Lambda, S3, Step functions, CloudWatch, Lightsail), Python]</span></h3>
