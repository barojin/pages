        ...
        <div className="resume-section-content">
          ...
          <div className="d-flex flex-column flex-md-row justify-content-between">            
            <div className="flex-grow-1">
              <h3 className="mb-0">Bounded-buffer problem <span className="text-primary">[C, semaphore, Ubuntu]</span></h3>
          ...
          <div className="d-flex flex-column flex-md-row justify-content-between">
            <div className="flex-grow-1">
              <h3 className="mb-0">Strategy Pattern implementation<span className="text-primary">[Java, JUnit]</span></h3>
          ...
          <div className="d-flex flex-column flex-md-row justify-content-between">
            <div className="flex-grow-1">
              <h3 className="mb-0">Web App with React.js, Node.js<span className="text-primary">[JavaScript, React, Node, NeDB, RESTful] </span></h3>
          ...
          <div className="d-flex flex-column flex-md-row justify-content-between">
            <div className="flex-grow-1">
              <h3 className="mb-0">Compute Unified Device Architecture(CUDA) programming with shared memory<span className="text-primary">[C++, CUDA Toolkit]</span></h3>
          ...
          <div className="d-flex flex-column flex-md-row justify-content-between">
            <div className="flex-grow-1">
              <h3 className="mb-0">Prouhet–Tarry–Escott problem on Message Passing Interface(MPI)<span className="text-primary">[C, Message Passing Interface library]</span></h3>
          ...
          <div className="d-flex flex-column flex-md-row justify-content-between">
            <div className="flex-grow-1">
              <h3 className="mb-0">Microservices on Spring<span className="text-primary">[Java, Spring framework, JPA, h2, HATEOAS, Netflix Eureka]</span></h3>
