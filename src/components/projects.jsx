        ...
        <div className="resume-section-content">
          <h2 className="mb-5">Projects</h2>                        
            ...
            <Project gitUrl="https://github.com/barojin/DjangoTutorial"
                ...
                content="Create the web site that shows polls and vote in them and admin site provide the add, change, and delete polls. It contains how to handle the route, models in the Database, automated testing, views and templates, admin page conventions, packaging to deploy and patching with git."
                />
