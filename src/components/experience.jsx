    ...
    <div className="resume-section-content">
      ...
      <div className="d-flex flex-column flex-md-row justify-content-between mb-5">
        <div className="flex-grow-1">
          ...
          <p>Create task automation(dynamic-link library, C\#, .NET) on Windows server with an open-source(selenium). The service reduced the time for the laborious task in the accounting department, which manually fetched bank statements of various online banking services, from a few hours to a second, and released it to production.</p>
          ...
          <p>Create new UIs, modify legacy functions in Windows Apps and query statements for Oracle SQL, write the documentation for the creation, and modification that I made.</p>
